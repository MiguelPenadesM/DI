...
import com.example.ejercicioventanalogin.Formulario.Respuestas.RespuestasController;
...
public class FormularioController implements Initializable {
    ...
    private void enviarDatos(MouseEvent event) {
        ...
        stage.close();
        try {
            Parent root = FXMLLoader.load(FormularioController.class.getClassLoader().getResource("fxml/Destino.fxml"));
            // Paso 1
