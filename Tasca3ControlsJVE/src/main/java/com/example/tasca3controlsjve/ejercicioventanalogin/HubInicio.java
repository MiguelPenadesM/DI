...
public class HubInicio {
    public void Ejercicio1(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(JVEApplication.class.getResource("tarea1Scene.fxml"));
    ...
    public void Ejercicio2(ActionEvent actionEvent) throws IOException {
        ...
        Stage stage= new Stage();
        FXMLLoader fxmlLoader = new FXMLLoader(JVEApplication.class.getResource("tarea2Calculadora.fxml"));
    ...
    public void Ejercicio3(ActionEvent actionEvent) throws IOException {
        ...
        Stage stage= new Stage();
        FXMLLoader fxmlLoader = new FXMLLoader(JVEApplication.class.getResource("form-view.fxml"));
